...
- `@deepseek-ai/dsh-client-ui-sidebar-documentpreview` — 需要 `clientModules`（[`packages/client/ui-sidebar-documentpreview/src/index.ts`](../packages/client/ui-sidebar-documentpreview/src/index.ts)）
